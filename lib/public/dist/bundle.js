...
var _mediaBitsExtractor = __webpack_require__(301);

var _mediaBitsExtractor2 = _interopRequireDefault(_mediaBitsExtractor);

var _randomnessExtractors = __webpack_require__(304);

var _randomnessExtractors2 = _interopRequireDefault(_randomnessExtractors);
...
function start() {
  var interval = 1000;
  extractor = new _mediaBitsExtractor2.default({ video: true, audio: true }, interval);
  var wait = function wait(n, cb) {
    var count = 0;
  ...
  var cb = function cb() {
    var bit = _randomnessExtractors2.default.innerProductExtractor([videoBits.split(''), audioBits.split('')]);
...
var padLeft = __webpack_require__(302);
...
/* WEBPACK VAR INJECTION */(function(module) {var getBitsInDataUrl = __webpack_require__(300);
var EventEmitter = __webpack_require__(299);
...
var rye = __webpack_require__(306);
var range = __webpack_require__(298);

var errors = __webpack_require__(113);
...
module.exports = {
  innerProductExtractor: extractorFactory(__webpack_require__(303))
};
